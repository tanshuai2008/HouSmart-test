...
with c_left:
    ...
    # Check Config for customized scoring
    config = config_manager.get_config()
    use_custom_weights = config.get("customized_scoring_method", False)
    ...
    config_model = config.get("model_name", "gemini-2.5-flash")
    if "input_model" not in st.session_state or st.session_state.input_model != config_model:
        st.session_state.input_model = config_model
